...
description: "Use git-based decentralized coordination to enable parallel agent work without conflict."
date: 2026-02-05
...
See also: [What 100 Parallel Agents Taught Us](/deep-dives/parallel-compiler-lessons.html) for the full case study, and [Task Scoping](/patterns/task-scoping.html) for how scoping interacts with parallelism.
